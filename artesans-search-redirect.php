...
class Artesans_Search_Redirect {
	...
	function __construct(){		
		...
		// TODO: update this - used throughout plugin code and only have to update here
		$this->ns_plugin_menu = "Artesans search redirect";
		// TODO: update this - used throughout plugin code and only have to update here
		$this->ns_plugin_slug = "artesans-search-redirect";
		// TODO: update this - used throughout plugin code and only have to update here
		$this->ns_plugin_ref = "artesans_search_redirect";
...
<p class="artesans-urls"><a href="https://www.omitsis.com" target="_blank">omitsis.com</a> | <a href="https://www.artesans.eu" target="_blank">artesans.eu</a></p>
		</div>
		<?php
	}
...
function modifica_busqueda ( $query ) {
	...
	if( $query->is_main_query() && $query->is_search ) {
		...
		?>
		<?php //echo "<pre>".print_r($redirections,true)."</pre>";?>
